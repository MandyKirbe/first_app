...
function update(index,link){
    ...
    button.addEventListener('click',()=>{
        ...
        let data = {id:"",name:"",email:"",address:"",birthday:"",height:"",vote:""};
        let dataToSend;
...
function add(form, link){    
    if (validaForm(form)){
        ...
        data.birthday = form._birthday.value;
        //toFixed faz com que as casas decimais do valor sejam sempre duas. 1.8 se torna 1.80, 1 se torna 1.00
        data.height = parseFloat(form._height.value).toFixed(2);
